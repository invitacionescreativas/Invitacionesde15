...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '542234488459'; // Número para el primer botón
  const phoneNumber2 = '541141878579'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '541141878579'; // Número para el primer botón
  const recipientNumber2 = '541141878579'; // Número para el segundo botón
