...
function updateTimer() {
  const targetDate = new Date("january 10, 2026 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543413904417'; // Número para el primer botón
  const phoneNumber2 = '543413904417'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543413904417'; // Número para el primer botón
  const recipientNumber2 = '543413904417'; // Número para el segundo botón
