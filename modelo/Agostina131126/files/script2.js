...
function updateTimer() {
  const targetDate = new Date("november 13, 2026 23:59:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543424403305'; // Número para el primer botón
  const phoneNumber2 = '543424403305'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543424403305'; // Número para el primer botón
  const recipientNumber2 = '543424403305'; // Número para el segundo botón
