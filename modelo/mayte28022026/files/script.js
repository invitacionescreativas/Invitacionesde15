...
function updateTimer() {
  const targetDate = new Date("february 28, 2026 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543464686230'; // Número para el primer botón
  const recipientNumber2 = '543464686230'; // Número para el segundo botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const restrictionNumber1 = '543464686230'; 
  const restrictionNumber2 = '543464686230'; 

  // Función para enviar mensaje por WhatsApp
  function sendFoodMessage(phoneNumber) {
  ...
  // Botones
  document.getElementById('botonRestriccion1').addEventListener('click', function () {
    sendFoodMessage(restrictionNumber1);
  });

  document.getElementById('botonRestriccion2').addEventListener('click', function () {
    sendFoodMessage(restrictionNumber2);
  });
});
